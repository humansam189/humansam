...
from models.depth_pro.mini_depth_pro_encoder import create_encoder_model_and_transforms
...
def main(args, ds_init):
    ...
    depth_model, depth_transforms = create_encoder_model_and_transforms()
    model = combined_model.CombinedModel(model, depth_model, args.nb_classes)
    if args.eval:
        combined_checkpoint = torch.load('/gemini/code/conf_xiaorong_best/checkpoint-best.pth', map_location='cpu')
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if data_loader_val is not None:
            ...
            if max_accuracy < test_stats["acc1"]:
                ...
                epochs_no_improve = 0  # nums of no improve epoch
                if args.output_dir and args.save_ckpt:
                    utils.save_model(
                        args=args, model=model, model_without_ddp=model_without_ddp, optimizer=optimizer,
